    ...
    <div className='container mx-auto p-4'>
       ...
       <div className='hidden lg:grid grid-cols-[200px,1fr]'>
         ...
         <div className='bg-white p-2 min-h-[calc(100vh-155px)] overflow-y-scroll'>
          {/* sort by */}
          <div className=''>
            <h3 className='text-base uppercase font-medium text-slate-500 border-b border-slate-300 pb-2'>Sort by</h3>
          ...
          {/* filter by */}
          <div className=''>
            <h3 className='text-base uppercase font-medium text-slate-500 border-b border-slate-300 pb-2'>Category</h3>
