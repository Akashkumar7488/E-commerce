...
const VerticalCard = ({loading,data =[]}) => {
  ...
  return (
    <div className=' grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))]  justify-center md:justify-between gap-6 md:gap-6 overflow-x-scroll scrollbar-none transition-all' >
